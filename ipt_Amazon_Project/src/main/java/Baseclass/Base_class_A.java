	...
	public static WebDriver setpro(String value) {
		if (value.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\shakt\\eclipse-workspace\\ipt_Amazon_Project\\driver\\chromedriver.exe");
		driver = new ChromeDriver();
			...
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\shakt\\eclipse-workspace\\ipt_Amazon_Project\\driver\\geckodriver.exe");
...
//******************************
	public static void screenshot(String screen) throws IOException {
		...
		File destination = new File(
				"C:\\Users\\shakt\\eclipse-workspace\\Nandhaa_Project\\screenshot\\" + screen + " .png");
